...
electrons = Species(type=Electron, charge_state=-1, name='beam')
background_gas = Species(type=Nitrogen, charge_state=0, name='beam')
ionized_gas = Species(type=Nitrogen, charge_state=+1, name='beam')
...
ionize = Ionization()
ionize.add_ionization(self, electrons, ionized_gas, target_species=background_gas, **kw)
