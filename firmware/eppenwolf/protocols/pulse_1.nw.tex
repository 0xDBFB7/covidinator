...
\nwfilename{pulse_1.nw}\nwbegindocs{1}\nwdocspar
Our aims with this experiment are to perform the following:

Avoid any ambiguity regarding the temperature rise seen in the

\nwenddocs{}\nwbegindocs{2}\nwdocspar
Inspired by \cite{Biocoder2010}, we write the microbiology protocol directly into the Eppenwolf firmware using literate programming.
...
\nwenddocs{}\nwbegincode{3}\moddef{microwave_spectrum.py}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
alalsdjkf
