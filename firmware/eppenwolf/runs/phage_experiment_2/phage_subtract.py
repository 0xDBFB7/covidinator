...
valid_lines = []
with open('phage_run_2.csv', "r") as f:
    for line in f:
        if(line.count(',') == 14):
...
#in this run, (looking after the fact, was blind before), on slide 0,  group A was not exposed, group B was.
#same for slide 1.
...
exposed_phages = get_data(2, slide_0, phage_1, near_sensor)
exposed_phages += get_data(2, slide_0, phage_3, near_sensor)
exposed_phages += get_data(2, slide_1, phage_1, near_sensor)
exposed_phages += get_data(2, slide_1, phage_3, near_sensor)

control_phages = get_data(2, slide_0, phage_0, near_sensor)
control_phages += get_data(2, slide_0, phage_2, near_sensor)
control_phages += get_data(2, slide_1, phage_0, near_sensor)
control_phages += get_data(2, slide_1, phage_2, near_sensor)
