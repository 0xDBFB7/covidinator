<Qucs Schematic >
<Properties>
  <View=-1607,-1130,5010,3110,0.839064,1273,712>
  <Grid=10,10,1>
...
<Components>
  ...
  <MLIN MS4 2 870 380 -26 15 0 0 "Subst1" 1 "Zwidth" 1 "10 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  ...
  <MLIN MS22 2 840 520 -115 -26 1 1 "Subst1" 1 "1 mm" 1 "5 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MLIN MS23 2 900 520 15 -26 0 1 "Subst1" 1 "1 mm" 1 "5 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <C C7 2 870 570 -26 17 0 0 "4pF" 1 "" 0 "neutral" 0>
  <C C8 1 730 220 -26 17 0 0 "4.7 pF" 1 "" 0 "neutral" 0>
  <MLIN MS25 1 800 300 15 -26 0 1 "Subst1" 1 "Zwidth" 1 "6 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MCORN MS26 1 800 220 15 -7 0 0 "Subst1" 1 "Zwidth" 1>
  <MCORN MS24 1 580 220 -7 -75 0 1 "Subst1" 1 "Zwidth" 1>
  <MLIN MS27 1 650 220 -26 15 1 2 "Subst1" 1 "Zwidth" 1 "4 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <GND *2 5 140 440 0 0 0 0>
  <GND *4 5 250 410 0 0 0 0>
  <Pac P1 1 140 410 18 -26 0 1 "1" 1 "50 Ohm" 1 "0 dBm" 0 "1" 0 "26.85" 0>
  <SPfile X2 1 250 380 -10 -44 0 0 "/home/arthurdent/Projects/covidinator/electronics/qucs/s2p_CE3520K3/CE3520K3v02n_2-26G_2V_10mA.txt" 0 "rectangular" 0 "linear" 0 "open" 0 "2" 0>
  <MLIN MS28 1 350 380 -26 20 0 0 "Sub1" 0 "316 um" 1 "7.92 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MLIN MS29 1 440 380 -26 20 0 0 "Sub1" 0 "0.790 um" 1 "5.3 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MLIN MS2 2 530 380 -26 15 0 0 "Subst1" 1 "Zwidth" 1 "10 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MLIN MS10 1 290 200 15 -26 0 1 "Subst1" 1 "Zwidth" 1 "10 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <GND *20 5 360 30 0 0 0 1>
  <Pac P18 0 330 30 -26 -78 0 2 "2" 1 "50 Ohm" 1 "0 dBm" 0 "1" 0 "26.85" 0>
  <R R5 1 320 110 -26 -55 1 0 "50 Ohm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
  <GND *24 5 350 110 0 0 0 1>
  <SUBST Subst1 1 -140 -530 -30 24 0 0 "4.4" 1 "0.79 mm" 1 "32 um" 1 "2e-4" 1 "0.022e-6" 1 "0.15e-6" 1>
  <Eqn MicrostripParameters 1 -140 -270 -31 17 0 0 "Zwidth=1.487e-3" 1 "yes" 0>
  <Eqn OptValues1 1 970 720 -28 15 0 0 "L1=1.345160E-02" 1 "L2=2.936499E-03" 1 "yes" 0>
  <.Opt Opt1 0 780 710 0 50 0 0 "Sim=AC1" 0 "DE=3|50|2|20|0.85|1|3|1e-6|10|100" 0 "Var=C1|yes|3.7e-12|0.3e-12|4.7e-12|LIN_DOUBLE" 0 "Var=L1|yes|0.0135|1e-3|20e-3|LIN_DOUBLE" 0 "Var=L2|yes|0.00294|1e-3|20e-3|LIN_DOUBLE" 0 "Goal=fb_gain|MAX|1" 0 "Goal=phase_shift|GE|300" 0>
</Components>
<Wires>
  ...
  <1110 380 1180 380 "Vfb_amp" 1170 340 35 "">
  ...
  <800 330 800 380 "" 0 0 0 "">
  <800 250 800 270 "" 0 0 0 "">
  <760 220 770 220 "" 0 0 0 "">
  <680 220 700 220 "" 0 0 0 "">
  <610 220 620 220 "" 0 0 0 "">
  <140 380 220 380 "Vsource" 80 330 23 "">
  <280 380 290 380 "" 0 0 0 "">
  <380 380 410 380 "" 0 0 0 "">
  <580 250 580 380 "" 0 0 0 "">
  <560 380 580 380 "" 0 0 0 "">
  <470 380 500 380 "" 0 0 0 "">
  <290 380 320 380 "Vamp1" 310 320 14 "">
  <290 230 290 380 "" 0 0 0 "">
  <290 30 290 110 "" 0 0 0 "">
  <290 30 300 30 "" 0 0 0 "">
  <290 110 290 170 "Vout" 250 130 40 "">
</Wires>
<Diagrams>
  ...
  <Rect 1440 350 562 331 3 #c0c0c0 1 00 1 2.5e+09 1e+09 1e+10 1 -1.10082 5 20 1 -1 0.5 1 315 0 225 "" "" "" "">
  ...
  <Rect 1040 248 279 178 3 #c0c0c0 1 00 1 2e+09 2e+09 1e+10 0 0 0.5 2 1 -1 1 1 315 0 225 "" "" "" "">
  ...
  <Rect 1440 760 570 338 3 #c0c0c0 1 00 1 0 0.2 1 1 -0.1 0.5 1.1 1 -0.1 0.5 1.1 315 0 225 "" "" "" "">
...
<Paintings>
  ...
  <Text 270 490 12 #000000 0 "5.5 GHz λ/4 50Z--(?Z)>100Z--(70Z)>50Z \ntransformer. Smoothens Vout power a bit,\nand seems to sharpen resonance at Vfb">
  <Text 950 620 12 #000000 0 "Rather than do a transient sim of the oscillation,\nthis second amp represents the first amp on the second\nFB loop around\n">
</Paintings>
