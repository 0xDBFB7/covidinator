...
def waveguide(pcb, position, f, lower_cutoff_frequency):
    #EIA WR102 rectangular waveguide 1.02 [25.908]	0.51 [12.954]
    ...
    # lambda_ = (1.0/f)*c
    #
    # guided_lambda = lambda_ / sqrt(1.0 - (lambda_ / lower_cutoff_frequency))
    #
    # length =
    #
    # dimension_x = 25.908 #mm
    # dimension_z = 12.954 #mm
    #
    # dimension_x = int(dimension_x/pcb.cell_size)
    # dimension_y = int(length/pcb.cell_size)
    # dimension_z = int(dimension_y/pcb.cell_size)
    #
    # thickness = 1

    # diameter = (27.79)

    waveguide_mask = np.zeros_like(copper_mask)

    waveguide_mask[0:dimension_x,0,] =
