...
$GMX_DIR/gmx_mpi mdrun -s ./output/s5/bilayer.tpr -v  -c ./output/s5/solvated_ionized_minimized.gro -o ./output/s5/minimized_energy.trr -e ./output/s5/ener.edr -g ./output/s5/md.log
