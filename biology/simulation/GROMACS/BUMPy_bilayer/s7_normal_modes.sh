...
$GMX_DIR/gmx_mpi grompp -f output/s7/s7_normal_modes.mdp -r ./output/s6/equilibriated.pdb -c ./output/s6/equilibriated.pdb -p output/topol.top -o ./output/s7/bilayer.tpr -maxwarn 1
