...
Protein net charges extracted from primary protein sequences compiled by the proteome-pI database \cite{ProteomepI2017} and UniProt using localCIDER \cite{CIDER2017}. See \ghfile{biology/data/net_charge.py} and structure.csv. Detailed source information will be added later! There are many.
