...
\item Induced polarization
		Persson cite a re-arrangement of electrons as a source of drag. Polarization-like effects are not expected. We have not followed up on this.
...
Poisson-Boltzmann family of equations is an extension of standard Laplace and Poisson potentials to solutions containing ions. 

Most situations solve this in equilibrium. However, we are specifically designing the pulse to be so short that ion equilibriation effects cannot occur. 

First the Poisson-Boltzmann equation is run to determine the screened charge density.
