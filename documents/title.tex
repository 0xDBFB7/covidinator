...
\begin{abstract}
	It has been suggested that the charge distribution and damping of the virus might offer some scope for inactivation by extreme electric fields, through mechanical forces on the envelope; a mechanism similar to, but distinct from, established lipid electroporation effects.\\
	...
	Some precedent exists for adjacent routes such as optical centrifuge and electrorotation; modifications to existing microsecond DC irreversible electroporation therapies may also be plausible; but we have not studied these techniques in any depth and have no reason to believe that they can be made practical or effective.\\
