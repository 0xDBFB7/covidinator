...
\author{Based primarily on excellent work by Liu et al, Yang et al, Hung et al, and at least 2,000 other groups.\\
	\\
		...
		\\
		{Daniel Correia}\ \orcidlink{0000-0002-9353-0216}, \textit{????????? York??????,}}
...
Previous studies appear to demonstrate that, due to its extremely anomalous quality factor. Then, net charge, rings up much like a singer might a wine glass. 

Such a non-thermal mechanism is quite unprecedented and extremely dubious; oft-posited but never substantiated; so it takes a good amount of convincing that this is not a very abstruse artifact.
...
This provides headroom of $10^8$.
