...
Previous studies appear to demonstrate that, due to its extremely anomalous quality factor and net charge, rings up much like a singer might a wine glass. Such a non-thermal mechanism is unprecedented; oft-posited but never substantiated; so it takes a good amount of convincing that this is not a very abstruse error.

This offers the tehnique a selectivity not seen

This paper simply deals with some trivial bookkeeping matters. We crudely replicate with Coliphage T4. 
...
With refinements, our inexpensive pulsed microwave spectrometer can obtain the data required with sufficiently concentrated specimens; but certain swept-EPR or ESR equipment may provide a much more sensitive spectrum \st{when used improperly} with modifications in technique. \\
