...
\begin{abstract}
	Dubious. Previous studies appear to neatly bracket this regime. We have attempted to replicate with a slightly improved thermal sham on Bacteriophage T4 in the 6 - 12 GHz band with an amplification-free fluorescence assay, but have been unable to attain the required >150 V/m field magnitude due to poor experimental design. We therefore contribute nothing to the scientific record; most of our discussion is not novel and is primarily qualitative.
	
	 We have some reservations regarding aspects of the previous research. With some imagination, the results can be ascribed purely to characteristic artifacts in this field, and we believe there may be inconsistencies in the observed protein charge and coupling by many orders of magnitude. If this effect exists, and inactivation is found to take place in less than$~10^6$ cycles, it appears to suggest a straightforward treatment, particularly in the sub-microsecond pulse regime, and especially when combined with Brillouin precursors.
\end{abstract}
