...
\begin{itemize}
  ...
  \item Showing that the deviation from the expected theshold could be explained by variance in the viron $\vert$ \cmark
  \item Taking 4 months to design a circuit with 2 transistors, thereby potentially leading to the maiming of hundreds of thousands of people and causing untold economic losses through negligence $\vert$ \cmark
