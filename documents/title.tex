...
\begin{abstract}
	...
	Given these assumptions, past experiments have suggested that there might some scope to produce mechanical forces sufficient to disrupt the viral membrane without acutely damaging the surrounding tissue, especially if the pulse spectrum is tuned to the normal modes of the virus.
