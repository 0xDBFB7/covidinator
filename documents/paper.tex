...
Testing was only performed with a surrogate bacteriophage. All experiments must be repeated with SARS-NCoV-2.
...
Contrary to Far UV, where ozone production.
...
There are some 20,000 papers on the topic of microwave safety, with solid in vitro, in vivo and epidemiological evidence of safety in the 2.4 GHz and 5.8 GHz bands.

However, "There are limited experimental human data upon which to set limits on exposures above 6 GHz" [Chan 2019]. The frequency ranges above 6 GHz appear to be set primarily by assuming purely thermal mechanisms and introducing a substantial safety factor of 20 or 50x.



The IEEE standard which the flagship paper [Yang 2015] references [IEEE C95.1–2005] was recently overhauled [IEEE C95.1-2019] with new metrics. The 
...
frequency, raise the quality factor of confined acoustic vibrations, and result in a microwave resonant absorption". But [Adair 2002]'s [Foster 1987] seem to quite conclusively put the kibosh on that idea, demonstrating no resonances and showing previous results to be an artifact of the measurement equipment.

However, [Sagripanti 1986] find DNA damage at $8.5 mW/g$ at 2.55 GHz, with only 0.8C heating of the solvent.

\paragraph{[Manikowska 1979]} \

9.4 GHz pulsed / in vivo, mouse, $0.1-10 \text{mW}/\text{m}^2$ over the whole body for 2 weeks.
...
More modern research does not tend to agree with these concerns. As cited by [ICNIRP 2020]'s excellent literature review, [Vijayalaxmi 2006] expose lymphocyte blood cells to pulsed 8.2 GHz radiation for 2 hours at an average power of $10 \text{mW/cm}^2$. They find no change in any of the parameters measured, including various chromosomal parameters. They further discuss previous results.



We must defer to health experts for interpretation of these data, and will not attempt to draw a conclusion.


It would be ideal to have an expert review our claims before publication. However, we tenatively make the following claims:

{\it Please contact the author if you are aware of other salient research, or have a different interpretation.}


Evidence of such microwave absorption resonances has been reported ([Edwards et al., 1984] [Grundler and Keilman, 1983], but these results have not been replicated ([Gabriel et al., 1987] [Foster et al., 1987]
...
[Foster (1987)] find that the DNA resonance found by [Edwards (1987)] was well below the experimental error, given the latter's setup. The Foster paper is of excellent quality.



 What is that in $mw/cm^2$?
...
[Hand 1982] $E_{mag}=1/e$ (13.5\% power density) skin\footnote{electromagnetic skin, not tissue skin}\footnote{well, both, I suppose.} depth of 10 GHz microwave is approximately:

\begin{center}
\begin{tabular}{|l|l|l|}
\hline
F=10 GHz          & Dry tissue & Wet tissue \\ \hline
Penetration depth & 30 mm      & $\sim$5 mm \\ \hline
\end{tabular}
\end{center}
...
However, destruction of lung tissue appears to be the 	[Yuan 2019]
...
We don't think this changes the substance of [Yang 2015]'s paper, if it is an error; it just means the mechanism is more useful for healthcare workers who acknowledge the risks.
