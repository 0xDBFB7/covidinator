...
Protein net charges extracted from protein sequences compiled by the proteome-pI database \cite{ProteomepI2017} and UniProt using localCIDER \cite{CIDER2017} \ghfile{biology/data/net_charge.py}. 
