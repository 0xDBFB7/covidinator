...
A correction factor due to the staggered magnetic field of the Yee lattice should be introduced;  Their $Z_2$ equation (correcting for spatial inaccuracies, but not temporal) was sufficient.
