...
Because this is an ostensibly novel and niche mechanism, it may behoove us to breifly review the biological basis for the safety limits set by standards organizations. 

For instance, we could question why we might not see such resonances in bodily tissues. After all, approximately similar nanoscopic structures exist in humans; for instance, nuclear pores (120 nm) and the famous microtubules (10x50 nm). 
...
[ICNIRP 2020], [ICNIRP 2019], [Adair]

The existence of resonance modes in DNA has been a matter of some contention; but the best data demonstrates 
quite conclusively 
...
\begin{tabular}{|l|l|l|}
\hline
 [Manikowska 1979] & 9.4 GHz pulsed &  \\ \hline
\end{tabular}
\end{center}

\begin{autem}
	{\it Evidence against safety}\

	\begin{itemize}
	  \item {[Manikowska 1979] / 9.4 GHz pulsed / 2 weeks\
	  
	   this is a particularly concerning paper. [Servantie 1989] discusses the (somewhat }
	  
	  \item {[Sagripanti 1986] find DNA damage at $8.5 mW/g$ at 2.55 GHz, without undue heating of the solvent.
	  	}
...
The conclusion that there can be no microwave resonances in DNA in water is in accord with the results of measurements in three different laboratories ([Gabriel et al., 1987] [Foster et al., 1987] using techniques designed to detect resonances with amplitudes less than 1/20th of that reported by [Edwards et al. (1984)].
