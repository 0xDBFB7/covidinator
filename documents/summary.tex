...
PMT dark counts and ambient light were removed by synchronous photon counting\cite{Measurement1966} - add when light is on, subtract when light is off.  This cannot be done with luminescence. Further filtering could be done by fluorescence lifetime discrimination. 
