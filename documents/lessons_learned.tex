...
it seems like older papers that establish the base facts of a field, perhaps because of un-searchable full text, or a lack of recent citations directly,means there is some sort of bias towards more recent, but more detail-sparse papers.



PLoS One doesn't allow footnotes. This seemed weird, but trying to rewrite inline actually does seem to make things a lot cleaner, and I'll try to keep this.


I've been muttering a lot about saving the results of the simulations. However, perhaps the real solution is to never undergo this trial-and-error technique - to learn enough about the problem, and to have enough testing in place. This might not ever be feasible.
...
%I hope that software should be written in a manner that is easy to support. This means documentation; reproducible builds; 
...
Memoization is more thoroughly considered in Scaling of Differential Equations with joblib.
