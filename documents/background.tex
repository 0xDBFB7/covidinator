...
\subsection{Liburdy's oxidation-dependent lipid leakage}

\subsection{Tsen femtosecond laser ISRU}
...
the vibrational mode; the optimal pulse duration is some fraction of the period of the mode in question.
 Unfortunately, these results appear to have failed replication \cite{No2011}. In any case, inactivation requires a very long duration; 
 unlikely to be of great clinical use.
