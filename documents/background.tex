...
. We can obtain the spring constant $k = \omega_{res}^2 m^*$ from the resonant frequency, where $m^*$ is the reduced mass.
, where 0.1 angstrom is derived from the lipid MD simulation. [that's not right!] 
