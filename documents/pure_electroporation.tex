...
There, the relevant time constants referred to the viscous loss of energy into the surrounding medium and the normal modes of the viral envelope; here the time constants relate to ion diffusion and capacitive charging. The relevant damage quantities were mechanical displacement and membrane stress, whereas here we consider transmembrane voltage and pore diameter. 
...
Viruses have extraordinary mechanical properties\footnote{Why is this? What selection pressures drive the selected pressure?}, so it seems reasonable that their dielectric properties could differ substantially from that of other structures. In the case of bacteriophages, the genome is packaged so tightly that the core is best considered an amorphous, glass-like material. ssRNA viruses like coronaviridae are perhaps somewhat less . On the other hand, the human "structome" also contains countless lipid vesicles that might plausibly 

The most obvious difference is scale. Viruses are minute. The classic Schwan equation implies that the transmembrane voltage 
