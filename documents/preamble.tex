...
\svgpath{{../biology/simulation/GROMACS/BUMPy_bilayer/data/}{../electronics/propagation/}{../math/mathematica/output/}{../biology/kotnik_transmembrane/plots/}}
...
%\usepackage{biblatex}
\usepackage[backend=bibtex8, sorting=none, style=phys, doi=true]{biblatex}
%style=phys
% style=chem-angew
% citestyle=verbose-ibid,bibstyle=phys
% , url=true, doi=true
...
\newcommand{\conclusiongrad}{\fbox{\faWarning,$\ \nabla\text{conclusion}$}}
...
\graphicspath{ {../media/} 
				...
				{../biology/FDTD/data/}
				{../math/mathematica/output/}
				{../firmware/eppenwolf/runs/phage_experiment_12/} 
				{../firmware/eppenwolf/runs/phage_experiment_8/} 
				{../biology/kotnik_transmembrane/plots/}
			}
