...
The direct inactivation plaque and PCR data in the referenced papers are somewhat convincing corroboration that this effect is not an artifact; but hundreds of convincing and wrong papers exist in the literature. Our data is crude and imprecise, our equipment hastily constructed, and should not be considered validation of this effect even existing. \\

Even if this effect exists and is as effective as it appears, it could still be impractical for any number of reasons. If you see anything fishy, please don't hesitate to post an issue.\\
